...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.db16ac5536e8c3483a07a1b45fd1b496e2deb3eecc8b2ddb89c4a169dd569f06.js',function(){input.required=false;search();});}
