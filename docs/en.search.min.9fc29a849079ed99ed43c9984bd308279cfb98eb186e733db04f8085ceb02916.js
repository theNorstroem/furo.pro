...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f5f3913feac42de129c8cd69bd9f2339f54cfaca96fc187a6179e59a8006c13a.js',function(){input.required=false;search();});}
