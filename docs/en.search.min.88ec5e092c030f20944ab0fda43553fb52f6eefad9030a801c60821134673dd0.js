...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ea0575b2b1caed5440d8e1cb669eb5d85de2216041391d9b5c18179c5163a4bb.js',function(){input.required=false;search();});}
