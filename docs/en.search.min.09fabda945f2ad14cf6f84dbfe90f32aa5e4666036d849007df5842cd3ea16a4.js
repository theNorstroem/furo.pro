...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ccb37a3e156c73e0fb30befb72761cbec655400ef44efde08af8acf1f7fbbe29.js',function(){input.required=false;search();});}
