...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.31005ddb8c1b8a013d8ffe0a798c724c0cffa3dadb91b732fd7dba6ddd0b2d98.js',function(){input.required=false;search();});}
