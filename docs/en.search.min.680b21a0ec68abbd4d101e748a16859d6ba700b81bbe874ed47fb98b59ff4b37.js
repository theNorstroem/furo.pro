...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5525661a68d2ee468ac72ae41f18c7121abb8f1621be42281799c8f43d10c1b2.js',function(){input.required=false;search();});}
